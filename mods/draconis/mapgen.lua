...
local cavern_spawning = minetest.settings:get("cavern_spawning") or true

local nest_spawn_rate = tonumber(minetest.settings:get("nest_spawn_rate")) or 25

local cavern_spawn_rate = tonumber(minetest.settings:get("cavern_spawn_rate")) or 25
