...
minetest.register_node('ma_pops_furniture:sofa_l_'..color, {
    ...
    mesh = 'FM_sofa_l.obj',
    tiles =  {'wool_'..color..'.png'},
    groups = {cracky=3, oddly_breakable_by_hand=2, flammable=1, not_in_creative_inventory=0, fall_damage_add_percent=-80, bouncy=80},
...
minetest.register_node('ma_pops_furniture:sofa_c_'..color, {
	...
	mesh = 'FM_sofa_c.obj',
	tiles =  {'wool_'..color..'.png'},
	groups = {cracky=3, oddly_breakable_by_hand=2, flammable=1, not_in_creative_inventory=0, furniture=1, fall_damage_add_percent=-80, bouncy=80},
	drop = 'ma_pops_furniture:sofa_'..color,
	paramtype = "light",
	paramtype2 = "facedir",
	sounds = {wood = {name="furn_bouncy", gain=0.8}},
