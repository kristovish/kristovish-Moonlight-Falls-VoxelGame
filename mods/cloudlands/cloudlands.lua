local ALTITUDE               = 3      -- average altitude of islands
local ALTITUDE_AMPLITUDE     = 2       -- rough island altitude variance (plus or minus)
...
local TREE_RARITY            = 0.8     -- Chance of a viable island having a giant tree growing out of it
local PORTAL_RARITY          = 0.09     -- Chance of a viable island having some ancient portalstone on it (If portals API available and ENABLE_PORTALS is true)
local BIOLUMINESCENCE        = true or -- Allow giant trees variants which have glowing parts
