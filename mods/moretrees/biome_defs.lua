...
moretrees.sequoia_biome = {
	surface = "default:dry_dirt_with_dry_grass",
	avoid_nodes = moretrees.avoidnodes,
	avoid_radius = 10,
	seed_diff = 333,
	min_elevation = 5,
...
moretrees.cedar_biome = {
	...
	avoid_radius = 10,
	seed_diff = 336,
	min_elevation = 3,  --Added to solve an issue where cedar trees would sometimes spawn deep underground
	near_nodes = {"default:water_source"},
	near_nodes_size = 15,
	near_nodes_count = 5,
	rarity = 50,
...
moretrees.fir_biome = {
	surface = "default:dirt_with_snow", "default:dirt_with_coniferous_litter",
	avoid_nodes = moretrees.avoidnodes,
	avoid_radius = 10,
	seed_diff = 359,
	min_elevation = 3,
